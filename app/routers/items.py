...
from .. import schemas
from ..services import Items, Storages
...
def create_item(
    ...
    """Create new item"""
    item = Items.create(db, payload.dict())
    return item
...
def update_item(
    ...
    """Update item"""
    item = Items.update(db, payload.dict())
    return item
...
def update_item_me(
    ...
    item = Items.check_existence(db, payload.item_id)
